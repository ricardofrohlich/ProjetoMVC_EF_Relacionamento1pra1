...
namespace Relacionamento1pra1.Controllers
{
    public class PessoasController : Controller
    {
        ...
        {
            return View(await _context.Pessoass.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pessoa = await _context.Pessoass
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var pessoa = await _context.Pessoass.FindAsync(id);
            if (pessoa == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.Pessoass.Any(e => e.PessoaId == id);
        }
    }
}
